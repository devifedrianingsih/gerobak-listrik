                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($product->ProductImage)
                                            <a href="javascript:void(0);" data-bs-toggle="modal"
                                                data-bs-target="#imageModal" data-image="{{ $product->ProductImage }}"
                                                class="view-image text-primary" title="Lihat Gambar">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-warning btn-sm edit-product" data-id="{{ $product->id }}"
                                            ...
                                            data-status="{{ $product->status }}" data-bs-toggle="modal"
                    ...
                    <form id="editProductForm" method="GET" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="Stock" id="editProductStock" class="form-control"
                                    required>
                            </div>
                            <div class="mb-3">
