        ...
        <div class="col-12 col-xl-5 col-xxl-4 auth-cover-right align-items-center justify-content-center">
          <div class="card rounded-0 m-3 mb-0 border-0 shadow-none bg-none">
            <div class="card-body p-sm-5">
              ...
              <p class="mb-0">Masukkan ID email Anda yang terdaftar untuk mengatur ulang kata sandi</p>
                ...
                <form class="row g-4">
                  ...
                  <div class="col-12">
                    <div class="d-grid gap-2">
                      <button type="button" class="btn btn-grd-info">Kirim</button>
                       <a href="{{ url('/auth-cover-login') }}" class="btn btn-light">Kembali Masuk Akun</a>
                    </div>
                  </div>
                </form>
              </div>
