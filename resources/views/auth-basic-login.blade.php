                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="form-body my-5">
                                <form class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group" id="show_hide_password">
                                            <input type="password" class="form-control border-end-0"
                                                id="inputChoosePassword" value="12345678" placeholder="Masukkan kata sandi">
                                    ...
                                    <div class="col-md-6 text-end"> <a href="{{ url('/auth-basic-forgot-password') }}">Lupa Kata Sandi?</a>
                                    </div>
                                    <div class="col-12">
                                        <div class="d-grid">
                                    ...
                                    <div class="col-12">
                                        <div class="text-start">
                                            <p class="mb-0">Belum punya akun? <a
                                                    href="{{ url('/auth-basic-register') }}">Daftar</a>
                                            </p>
                                        </div>
                                    </div>
                                </form>
