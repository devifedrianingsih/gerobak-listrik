                            ...
                            @else
                                @foreach ($mitra as $key => $mitr)
                                    <tr>
                                        ...
                                        <td>{{ ucfirst($mitr->status) }}</td>
                                        <td>{{ ucwords(str_replace('-', ' ', $mitr->aktif)) }}</td>
                                        <td>{{ $mitr->approvedBy->name ?? '-' }}</td>
                                        <td class="text-center align-middle">
                                            <button type="button"
                                                ...
                                                title="Edit">
                                                <i class="bx bx-edit fs-5 text-white m-0 p-0"></i>
                                            </button>
                                        </td>
                                        <td class="text-center align-middle">
                                            <form method="POST" action="{{ route('mitra.delete', ['id' => $mitr->id]) }}"
                                                onsubmit="return confirm('Yakin ingin menghapus?');"
                                                class="m-0 p-0 d-flex justify-content-left align-items-left">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        @foreach ($fields as $field => $label)
                                                            <div class="row mb-2">
                                                                ...
                                                                @if ($field == 'kode_mitra')
                                                                    <div class="row mb-2">
                                                                        <label class="col-sm-3 col-form-label">Disetujui Oleh</label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" value="{{ $mitr->approvedBy->name ?? '-' }}" disabled>
                                                                        </div>
                                                                    </div>
                                                                @endif
                                                        @endforeach
