...
<div class="products-cart-container">
    <div class="dropdown-wrapper">
        ...
        <ul id="dropdown-menu" class="dropdown-content">
            ...
            <li><a href="/cart">Paket Bahan Baku</a></li>
        </ul>
    </div>
    ...
    <section class="products">
        <div class="product" data-name="Paket Super A" data-price="19.000.000">
            ...
            <h2>Paket Super A</h2>
            <p>Paket Bundling Super A termasuk: Gerobak Listrik + Bahan baku (Semua Varian) + Produk Bahan Baku (1 Bulan)</p>
        ...
        <div class="product" data-name="Paket Super B" data-price="14.000.000">
            ...
            <h2>Paket Super B</h2>
            <p>Paket Bundling Super B termasuk: Gerobak Listrik + Bahan baku (Semua Varian) + Produk Bahan Baku (1 Bulan)</p>
        ...
        <div class="product" data-name="Paket Super C" data-price="9.000.000">
            ...
            <h2>Paket Super C</h2>
            <p>Paket Bundling Super C termasuk: Gerobak Listrik + Bahan baku (Semua Varian) + Produk Bahan Baku (1 Bulan)</p>
